<header id='cms_header'>
    <select id='cms_nav'>
        <option value='cms.activities.php'>Activiteiten</option>
        <option value='cms.agenda.php'>Agenda</option>
        <option value='cms.banners.php'>Banners</option>
        <option value='cms.competition.php'>Competitie</option>
